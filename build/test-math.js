...
import { Vector2D, calculateGravitationalForce, calculateGravitationalForceVector } from './main.js';
...
const earthMoonForce = calculateGravitationalForceVector(earthMassScaled, earthPos, moonMassScaled, moonPos);
